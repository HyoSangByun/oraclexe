...
문자열 및 날짜
    ...
    기본 날짜 표시형식 DD-MON-RR
    SQL Developer는 RR-MON-DD
*/
...
SELECT last_name
FROM employees
WHERE last_name LIKE '_o%'; -- o앞에 한글자만 대체된다.

--ESCAPE 식별자
SELECT employee_id, last_name, job_id
FROM employees
WHERE job_id LIKE '%SA\_%' ESCAPE '\'; --'SA_'를 포함하는 job_id 검색. / 대신 $ 도 가능

/*
NULL 조건 사용
    IS NULL 연산자로 NULL을 테스트한다.
*/
SELECT last_name, manager_id
FROM employees
WHERE manager_id IS NULL; -- = NULL로 하면 안된다.
